...
.subagent-card { margin: 12px 0; overflow: hidden; border: 1px solid #e4e7ec; border-radius: 8px; background: #fff; }
...
.subagent-card-icon { display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border-radius: 6px; background: #f0f7ff; color: #1677ff; font-size: 15px; }
