...
public class ThreadSessionManager {
    ...
    /**
     * Remove all sessions associated with the given agentId.
     *
     * @param agentId The agent identifier
     */
    public void removeSessionsByAgentId(String agentId) {
        int[] removed = {0};
        ...
        if (removed[0] > 0) {
            logger.debug("Removed {} session(s) for agentId: {}", removed[0], agentId);
        }
    }
